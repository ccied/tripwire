<?php
	...
	define( 'USERNAME',	"BLANKED_FOR_RELEASE"	);	// YOUR LOGIN
	define( 'PASSWORD',	"BLANKED_FOR_RELEASE");	// YOUR PASSWORD
	...
	for( $i = 0; $i < 3; $i++ ) {
		...
		$res = $ccp->picture2( $question, $pict_to, $pict_type, $text, $major_id, $minor_id );
		switch( $res ) {
